...
/* package custom-xmobar-0.1.0.0 */
#ifndef VERSION_custom_xmobar
#define VERSION_custom_xmobar "0.1.0.0"
#endif /* VERSION_custom_xmobar */
#ifndef MIN_VERSION_custom_xmobar
#define MIN_VERSION_custom_xmobar(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_custom_xmobar */
...
#define CURRENT_COMPONENT_ID "custom-xmobar-0.1.0.0-inplace-custom-xmobar"
